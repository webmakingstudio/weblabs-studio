...
export default function PricingCard({
    ...
    subtitle = "Soluciones de precios profesionales",
    description = "Soluciones de precios premium para las necesidades de tu negocio.",
    features = ["Planes de precios flexibles", "Soluciones personalizadas", "Soporte 24/7", "Características premium"],
    isDark = true,
}: CardFlipProps) {
